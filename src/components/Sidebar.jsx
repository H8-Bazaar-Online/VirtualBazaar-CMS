  ...
  return (
    <div className="w-2/12 bg-white rounded p-3 shadow-lg divide-y divide-gray-900">
      <div className="flex items-center space-x-4 p-2 mb-5">
        ...
        <div>
          <h4 className="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">{localStorage.name}</h4>
      ...
      <ul className="space-y-2 text-sm pt-5">
        ...
        <li>
          <button onClick={handleLogout} className="w-full flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline">
            <span className="text-gray-600">
              <svg className="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
